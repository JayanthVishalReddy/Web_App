    ...
    return  (
        ...
        <Container>
            <form onSubmit={handleSubmit} className={commonModelClasses}>
                ...
                <p className='text-center dark:text-dark-subtle text-light-subtle'>OTP has sent to your email</p>
                </div>
                    ...
                    return(
                        ...
                        key={index}
                         ...
                         className='w-12 h-12 border-2 dark:border-dark-subtle border-light-subtle
                          dark:focus:border-white  focus:border-primary rounded
                ...
                <button onClick={ handleOTPResend } type='button' className="dark:text-white text-blue-500 font-semibold
