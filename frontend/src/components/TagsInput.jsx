  ...
  return (
    <div>
      <div
        ...
        overflow-x-auto custom-scroll-bar transition dark:text-white text-primary"
      >
        {tags.map((t) => (
        ...
        <input
          ...
          type="text"
          id={name}
          className="h-full flex-grow bg-transparent outline-none dark:text-white dark:text-white text-primary"
