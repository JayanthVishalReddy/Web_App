...
exports.validatePassword=[
    ...
    withMessage("Password length must be 8 to 20 charecters long!"),
];

exports.actorInfoValidator=[
    check("name").trim().not().isEmpty().withMessage("Actor Name is Missing"),
    check("about").trim().not().isEmpty().withMessage("About actor is Missing"),
    check("gender").trim().not().isEmpty().withMessage("Actor gender is Missing")
];
